...
(async () => {
  try {
    ...
    await page.goto('https://br.advfn.com/bolsa-de-valores/bmf/DI1F29/cotacao', {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbz7TlC7nLoNvV_tuXrxk2qwT_hVmyRQZt2pmEQOpzNwPerxmEtSvTWTO58IkAlb5P2b/exec'; // Insira o URL do seu Apps Script aqui
