...
(async () => {
  try {
    ...
    await page.goto('https://br.advfn.com/bolsa-de-valores/bmf/DI1F31/cotacao', {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycby7vSSi2ygkyiwhtj7iR_x89sV-k6nSAmHuPWLfyHYfZ2togcP17rFBt_gi-AppM5av/exec'; // Insira o URL do seu Apps Script aqui
