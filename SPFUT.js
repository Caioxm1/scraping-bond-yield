...
(async () => {
  try {
    ...
    await page.goto('https://br.investing.com/indices/us-spx-500-futures', {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbwe_iNWe0pIqd8y0mxjjiZL61OMNQbgTodvdJJZDZeqAd9mBGkNXaKR5wmIZYI4CpxN/exec'; // Insira o URL do seu Apps Script aqui
