...
(async () => {
  try {
    ...
    await page.goto('https://br.advfn.com/bolsa-de-valores/nasdaqi/COMPX/cotacao', {
      waitUntil: 'domcontentloaded',
    });

    // Capturar o valor da porcentagem usando o XPath
    const percentage = await page.evaluate(() => {
      const xpath = '/html/body/div[6]/div[2]/div[1]/div/div/div[2]/div[1]/div/div[2]/div';
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbzzC-rZs9Uj1U-FUS6ssDw6XkHt2v8x-4JWCPEKYqgwUe2EugQwPzmjMDAJV4JOvZep/exec'; // Insira o URL do seu Apps Script aqui
