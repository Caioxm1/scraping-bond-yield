...
(async () => {
  try {
    ...
    await page.goto('https://br.investing.com/rates-bonds/u.s.-5-year-bond-yield', {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbwg6_FmFgBWLsJEUmMJSxR_zzAypCb3nrOAGI9ddeqLyLfLgpJlx0qaS57jOP0C86tM/exec'; // Insira o URL do seu Apps Script aqui
