...
(async () => {
  try {
    ...
    await page.goto('https://br.advfn.com/bolsa-de-valores/dowi/DJI/cotacao', {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbwpBip6p0DTPpJXtdGqN3-EHjPNMMUolP_rjkExtSXwQOmVWpGFjFU0hU67pyLf74L0/exec'; // Insira o URL do seu Apps Script aqui
