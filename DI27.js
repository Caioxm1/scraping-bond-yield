...
(async () => {
  try {
    ...
    await page.goto('https://br.advfn.com/bolsa-de-valores/bmf/DI1F27/cotacao', {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbxovJ_hDLQM7kDatAgIaDIjffMgEBHCWhYBEqVdHvTJCa7wgQOTqbZrPfYinsT6pMni/exec'; // Insira o URL do seu Apps Script aqui
